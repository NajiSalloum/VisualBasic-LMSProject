...
Namespace Migrations
    ...
    Public NotInheritable Partial Class NullableCourseId
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(NullableCourseId))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201808111259268_NullableCourseId"
            End Get
        End Property
